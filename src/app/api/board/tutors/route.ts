...
export async function GET(request: Request) {
  ...
  let q = supabase
    .from("tutor_posts")
    .select("id, real_name, university, identity, badge_text, gender, teach_mode, regions, grades, subjects, min_salary, max_salary, note, teaching_style, auth_files, status, serial_number, created_at")
    .eq("status", "verified")
