...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from("tutor_posts")
    .select("id, real_name, university, identity, gender, teach_mode, regions, grades, subjects, min_salary, max_salary, note, status, created_at")
